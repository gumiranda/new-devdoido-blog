...
CREATE TYPE "public"."schedule_frequency" AS ENUM('daily', 'hours', 'weekly');--> statement-breakpoint
CREATE TYPE "public"."transaction_action" AS ENUM('transcribe_minute', 'generate_article', 'index_check', 'monthly_subscription', 'recharge');--> statement-breakpoint
CREATE TYPE "public"."transaction_category" AS ENUM('article', 'transcribe', 'index', 'recharge', 'subscription');--> statement-breakpoint
...
CREATE TABLE "automation_config" (
	...
	"model" varchar(100) DEFAULT 'claude' NOT NULL,
...
CREATE TABLE "channel" (
	...
	"color" text DEFAULT 'linear-gradient(135deg,#8257e6,#6420aa)' NOT NULL,
	"letter" text DEFAULT 'C' NOT NULL,
...
CREATE TABLE "google_connection" (
	...
	"avatar_letter" text DEFAULT 'G' NOT NULL,
	"access_token" text,
	"refresh_token" text,
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "google_connection_workspace_id_unique" UNIQUE("workspace_id")
);
--> statement-breakpoint
...
CREATE TABLE "schedule_config" (
	...
	"quota_per_run" integer DEFAULT 412 NOT NULL,
...
CREATE TABLE "workspace_settings" (
	...
	"category" text DEFAULT 'blog' NOT NULL,
	"color" text DEFAULT 'hsl(217 91% 55%)' NOT NULL,
	"description" text,
	"website" text,
	"instagram" text,
	"cover_url" text,
...
ALTER TABLE "channel" ADD CONSTRAINT "channel_google_connection_id_google_connection_id_fk" FOREIGN KEY ("google_connection_id") REFERENCES "public"."google_connection"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "article_slug_unique" ON "article" USING btree ("workspace_id","slug");--> statement-breakpoint
CREATE UNIQUE INDEX "tag_slug_unique" ON "article_tag" USING btree ("workspace_id","slug");